...
int main(int argc, char** argv) {
    ...
    hc.alias_region_base = HostRegion::reserved_base();  // access the static memory reserved for memory aliasing
    std::unique_ptr<H2DLeg> h2d = H2DLeg::create(mesh, hc, err);
    if (!h2d) {
