...
PrefetcherPipeImpl::PrefetcherPipeImpl(
    ...
    TT_FATAL(space_ != nullptr, "DRAM-sender PrefetcherPipe requires a PrefetcherPipeSpace");
...
void PrefetcherPipeImpl::build_dram_sender_config_pages() {
    ...
    distributed::MeshDevice* mesh_device = space_->get_device();
    config_pages_.clear();
