...
// ============================================================================
// PrefetcherPipe (experimental) -- why it lives in advanced options
// ============================================================================
//
// PrefetcherPipe is a separate experimental effort (a durable 1:N L1 ring with credit flow
// control, reserved through PrefetcherPipeSpace outside any Program). Its Metal 2.0 surface is
// kept entirely in the *AdvancedOptions structs so that the core spec (KernelSpec,
// DataflowBufferSpec, ProgramSpec, ProgramRunArgs) can graduate without depending on it:
//
//   ProgramAdvancedOptions::prefetcher_pipe_parameters   geometry of the pipes a Program uses
//   KernelAdvancedOptions::prefetcher_pipe_bindings      DM kernel <-> pipe accessor (pipe::<name>)
//   DFBAdvancedOptions::prefetcher_pipe_relays           DFB aliasing a pipe ring for compute
//   AdvancedProgramRunArgs::prefetcher_pipe_args         the live pipe objects, bound at run time
//
// See prefetcher_pipe_parameter.hpp for the programming model.
