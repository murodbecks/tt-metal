 ...
 * Leaves SrcA/SrcB on dfb_in_rm and PACK on dfb_in; the caller re-establishes both for its
 * next op with reconfig_data_format / pack_reconfig_data_format plus that op's short init.
 */
