...
// (writer←SRC1) pipeline through a super-block; single-buffer forces strictly alternating
// untilize / gather because the writer now barriers+pop_fronts inside the w_tile loop.
